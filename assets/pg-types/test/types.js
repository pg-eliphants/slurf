...
const { Range, RANGE_EMPTY, RANGE_LB_INC, RANGE_LB_INF, RANGE_UB_INF, RANGE_UB_INC } = require('postgres-range');
...
exports.timestamptz = {
    ...
    id: 1184,
    tests: [
        ['2010-10-31 14:54:13.74-05:30', dateEquals(2010, 9, 31, 20, 24, 13, 740)],
        ['2011-01-23 22:05:00.68-06', dateEquals(2011, 0, 24, 4, 5, 0, 680)],
        ['2010-10-30 14:11:12.730838Z', dateEquals(2010, 9, 30, 14, 11, 12, 730)],
        ['2010-10-30 13:10:01+05', dateEquals(2010, 9, 30, 8, 10, 1, 0)],
        ['1000-01-01 00:00:00+00 BC', dateEquals(-999, 0, 1, 0, 0, 0, 0)]
    ]
};
...
exports.timestamp = {
    ...
    tests: [
        [
            '2010-10-31 00:00:00',
            function (t, value) {
                t.equal(value.toISOString(), '2010-10-31T00:00:00.000Z');
            }
        ],
        [
            '1000-01-01 00:00:00 BC',
            function (t, value) {
                t.equal(value.toISOString(), '-000999-01-01T00:00:00.000Z');
            }
        ]
    ]
};
